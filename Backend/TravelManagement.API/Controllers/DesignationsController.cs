...
public class DesignationsController : ControllerBase
{
    ...
    [RequirePermission(Permissions.DesignationsCreate)]
    ...
    [HttpPut("{id}")]
    [Authorize(Policy = "StaffOrAbove")]
    [RequirePermission(Permissions.DesignationsEdit)]
    ...
    [HttpPost("{id}/active")]
    [Authorize(Policy = "StaffOrAbove")]
    [RequirePermission(Permissions.DesignationsToggle)]
    ...
    [HttpDelete("{id}")]
    [Authorize(Policy = "StaffOrAbove")]
    [RequirePermission(Permissions.DesignationsDelete)]
